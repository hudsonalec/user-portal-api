...
@CrossOrigin(origins="*", allowedHeaders="*") // allows the userController to be hit by other resources
public class UserController {
	...
	public ResponseEntity<User> addUser(@Valid @RequestBody User u) { // @Valid ensures that the user object accepted
		...
		// what happens if a user tried to add a malfunctioned JSON object ???
		// we will user the power of AOP to intercept the response that's sent back so the user/client
		//knows how to fix it
